...
class SmartAssistantBridge:
    """Bridge to connect OM1 with Smart Assistant (Home Assistant)"""
...
class VoiceCommandProcessor:
    """Processor for voice command from smart assistant"""

    def __init__(self):
        self.command_patterns = {
            "order": ["order", "order", "beli", "buatkan"],
    ...
    def _extract_name(self, command: str) -> str:
        ...
        # Simple implementation - can be developed
